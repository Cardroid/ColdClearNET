...
namespace ColdClearNET
{
    ...
    public class ColdClear : IDisposable
    {
        ...
        /// <summary>
        /// 지정된 옵션과 무게를 사용하여 빈 보드, 빈 대기열 및 가방의 7개 피스가 모두 포함된 봇 실을 실행하십시오.<br/>
        ...
        /// <summary>
        /// 기본 옵션과 무게를 사용하여 빈 보드, 빈 대기열 및 가방의 7개 피스각 모두 포함된 봇 쓰레드를 실행하십시오.<br/>
        /// 봇 인스턴스가 완료되면 Disposition()을 호출하는 것을 잊지 마십시오.
        /// </summary>
        public ColdClear() : this(GetDefaultOptions(), GetDefaultWeights()) { }

        /// <summary>
        /// 큐 끝에 새 피스를 추가한다.<br/><br/>
        ///
        ...
        /// <summary>
        /// 가능한 한 빨리 봇에게 이동을 제공하도록 요청한다.<br/><br/>
        /// 
        ...
        /// <summary>
        /// 이전에 요청한 이동을 봇에서 제공했는지 확인하십시오.<br/><br/>
        /// 
        ...
        /// <summary>
        /// 봇에게 가능한 한 빨리 이동을 제공하도록 요청하고 이를 반환한다.<br/><br/>
        ///
        /// 대부분의 경우, "가능한 한 빨리"는 매우 짧은 시간이며, 제공된 사고력의 하한선이 아직 도달하지 않았거나, 또는 봇이 다음 피스에 대한 정보가 부족하기 때문에 아직 움직임을 제공할 수 없는 경우에만 더 길다.<br/><br/>
        /// 
        ...
        /// <summary>
        /// 가능한 모든 피스 배치 시퀀스가 사망으로 귀결되거나 봇 쓰레드가 충돌할 경우 true를 반환한다.
        /// </summary>
